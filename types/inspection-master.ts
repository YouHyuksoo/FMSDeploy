...
export const periodTypeLabels: Record<PeriodType, string> = {
  [PeriodType.DAILY]: "매일",
  [PeriodType.WEEKLY]: "매주",
  [PeriodType.MONTHLY]: "매월",
  [PeriodType.QUARTERLY]: "매분기",
  [PeriodType.SEMI_ANNUALLY]: "매반기",
  [PeriodType.ANNUALLY]: "매년",
  [PeriodType.CUSTOM_DAYS]: "사용자 정의 (일)",
  [PeriodType.CUSTOM_WEEKS]: "사용자 정의 (주)",
  [PeriodType.CUSTOM_MONTHS]: "사용자 정의 (월)",
  [PeriodType.CUSTOM_YEARS]: "사용자 정의 (년)",
  [PeriodType.ON_DEMAND]: "비정기",
}
...
export interface InspectionMaster {
  ...
  revisionHistory?: Array<{ version: string; date: string; changes: string; revisedBy: string }> // 개정 이력
  tags?: string[] // 태그
